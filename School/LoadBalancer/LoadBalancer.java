...
public class LoadBalancer {
    ...
    // Constructor for LoadBalancer class, initializes the list of servers with their host names and ports
    // Saw other people do this so why not?
    public LoadBalancer() {
    ...
    public void start() throws IOException {
        ...
        while (true) {
            ...
            // Accept client connection. This line seems to wait here until there is a connection.
             ...
             * 
             * Keep in mind that this is is a ServerInfo object. 
             */
