<?php
  ...
  $continents = [ "Africa", "Asia","Europe","North America", "South America", "Bald Island"  ];

  $countries = [
    "CA"=>"Canada","FR"=>"France","IT"=>"Italy","DE"=>"Germany","GH"=>"Ghana","GR"=>"Greece","ES"=>"Spain","US"=>"United States","GB"=>"United Kingdom", "BS"=>" British Shilumbia"
  ];  
  ...
  $posts = [
    ...
    ["postId"=>4, "userId"=>12, "userName"=>"Connor Order", "date"=>"2/14/2025","thumb"=>"8710289254.jpg","title"=>"I HATE YOU","reviewsNum"=>0,"reviewsRating"=>0,"excerpt"=>"I HATE YOU AND YOU ARE A WORTHLESS HUMAN BEING. Happy Hanukkah"]
  ];
